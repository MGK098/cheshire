...
set ROOT "/srv/home/muhammad.ghassan/Cheshire/lorenzo_cheshire"

if {[catch { vlog -incr -sv \
    -suppress 2583 -suppress 13314 -timescale 1ns/1ps \
    "+define+TARGET_CV64A6_IMAFDC_SV39_HPDCACHE_WB" \
    "+define+TARGET_CVA6" \
    "+define+TARGET_RTL" \
    "+define+TARGET_SIM" \
...
if {[catch { vlog -incr -sv \
    ...
    "+incdir+$ROOT/.bender/git/checkouts/cva6-7b729dce775b20ea/core/cache_subsystem/hpdcache/rtl/include" \
    "+incdir+$ROOT/.bender/git/checkouts/cva6-7b729dce775b20ea/core/include" \
    "$ROOT/.bender/git/checkouts/cva6-7b729dce775b20ea/core/include/cv64a6_imafdc_sv39_hpdcache_wb_config_pkg.sv" \
}]} {return 1}
...
set SARG_ROOT [file normalize [file join [file dirname [info script]] ../../..]]
vlog "$SARG_ROOT/target/sim/src/elfloader.cpp" -ccflags "-std=c++11" -cpppath "/usr/lib64/ccache/g++"
